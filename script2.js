...
var q = {
    ...
    2: {"title": "친한 친구가 단톡방에 '나 요즘 너무 외롭다'고 보냈지만 아무도 답장을 하지 않는다. 그걸 본 나의 반응은?", "type": "TF", "A": "‘음… 괜히 반응했다가 부담될 수도 있으니 일단 관망하자’", "B": "‘헉… 얼마나 외로웠으면 저 말까지 했을까’ 하며 바로 카톡 보내기"},
    ...
    5: {"title": "친구가 SNS에 '버티기 힘들다'는 글을 올렸다. 나는 그것을 보고 어떤 생각을 할까?", "type": "TF", "A": "‘뭐야…’ 대수롭지 않게 넘기고 반응 안 함", "B": "“너무 걱정돼… 얘기해줘”라고 DM함"},
